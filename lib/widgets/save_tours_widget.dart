...
import 'package:travel_book/screens/dashboard/home/tour_screen.dart';
...
class SaveToursWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: (){
        context.push(child:  TourScreen(model: model,));
      },
      child: SizedBox(
        child: Row(
          children: [
